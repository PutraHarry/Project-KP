    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    {{-- <tr>
                        <th colspan='18' id="opd">SKPD :</th>
                    </tr>
                    <tr>
                        <th rowspan='1' colspan='18' id="periode">Periode : </th> --}}
                    </tr>
                    {{-- <tr>
...
<script>
    ...
    var opd = {!! json_encode($opd->toArray()) !!}
    var periode = {!! json_encode($periode->toArray()) !!}
    let count = 0;
    ...
    barang.forEach(element1 => {
        ...
        $.ajax({
            type: 'GET',
            url: '/coba1/' + element1.id + '/' + opd.id + '/' + periode.id,
