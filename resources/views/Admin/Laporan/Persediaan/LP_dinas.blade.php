...
@section('content')
  @if (session()->has('statusInput'))
    ...
    <section class="content">
                ...
                <div class="card-header">
                    <div class="card-tools">
                      @if (in_array(auth()->guard('admin')->user()->jabatan->jabatan, ['PPBPB', 'PPBP']))
                        <a href="#" class="btn btn-primary btn-icon-split hide">
                            <span class="icon">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body mx-lg-5">
                                ...
                                <div class="col-sm-11">
                                    <select class="select2" name="opd" id="opd" style="width: 100%">
                                    @foreach ($opd as $opd)
                                ...
                                <div class="col-sm-11">
                                    <select class="select2" name="periode" id="periode" style="width: 100%">
                            ...
                            <div class="card-footer">
                                <button id="btn" class="btn btn-default float-right">Cancel</button>
                            </div>
                            <!-- /.card-footer -->
                        </div>  
                    </div>
      ...
      <section class="content" id="test"></section>
    </div>
@endsection
...
$("input[data-bootstrap-switch]").each(function(){
  ...
  <script>
    let idOPD = $('#opd').val();
    let idPeriode = $('#periode').val();
    $('#btn').click(function() {
      $.ajax({
        type: 'get',
        url: '/laporan/getDataTabel/' + idOPD + '/' + idPeriode,
