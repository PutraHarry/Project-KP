...
(1,5,1,2,68000,'baik','2021-10-24 04:19:30','2021-10-24 04:19:30',NULL),
(2,5,2,3,102000,'baik','2021-10-24 04:19:30','2021-10-24 04:19:30',NULL);
...
(6,8,1,1,34000,'baik','2021-10-23 15:29:29','2021-10-23 15:29:29',NULL);
...
(42,20,1,1,34000,'baik','2021-10-24 06:34:14','2021-10-24 06:34:14',NULL),
(43,19,1,2,68000,'baik','2021-10-24 06:37:33','2021-10-24 06:37:33',NULL);
...
(2,'Admin_BPKAD',NULL,NULL,NULL),
(3,'PPBPB',NULL,NULL,NULL),
(4,'KASI',NULL,NULL,NULL),
(5,'PPBP',NULL,NULL,NULL),
(6,'Tim_Verifikasi',NULL,NULL,NULL),
...
(3,'canang',1000,'biji','KIB C',NULL,'2021-10-25 07:30:30',NULL),
(4,'test kib d',10000,'buah','KIB D',NULL,NULL,NULL),
(5,'test kib e',30000,'buah','KIB E',NULL,NULL,NULL),
(6,'test kib f',10500,'buah','KIB F',NULL,NULL,NULL);
...
insert  into `tb_penerimaan`(`id`,`kode_penerimaan`,`jenis_penerimaan`,`tgl_terima`,`pengirim`,`status_penerimaan`,`total`,`ket_penerimaan`,`id_periode`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'BPKAD123','APBD Non Obat','0202-01-01','Orang A','draft',170000,NULL,NULL,'2021-09-13 18:06:49','2021-10-03 22:05:05',NULL),
(2,'BPKAD312','APBD Obat','2021-01-01','Orang B','final',34000,'test',NULL,'2021-09-14 17:38:22','2021-10-24 12:25:06',NULL);
...
insert  into `tb_pengeluaran`(`id`,`kode_pengeluaran`,`id_penggunaan`,`tgl_keluar`,`ket_pengeluaran`,`status_pengeluaran`,`total`,`id_periode`,`created_at`,`updated_at`,`deleted_at`) values 
(2,'BPKAD/PGL/1',2,'2021-01-01','test','draft',NULL,NULL,'2021-10-22 16:44:37','2021-10-22 16:44:37',NULL),
(3,'BPKAD/PGL/2',3,'2021-02-01','test 2','draft',NULL,NULL,'2021-10-23 15:17:29','2021-10-23 15:17:29',NULL),
(5,'BPKAD/PGL/4',7,'2021-04-01','test 4 test','final',170000,NULL,'2021-10-23 15:30:23','2021-10-24 04:18:34',NULL);
...
CREATE TABLE `tb_penggunaan` (
  ...
  CONSTRAINT `tb_penggunaan_ibfk_3` FOREIGN KEY (`id_penerimaan`) REFERENCES `tb_penerimaan` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_penggunaan` */

insert  into `tb_penggunaan`(`id`,`kode_penggunaan`,`id_penerimaan`,`tgl_penggunaan`,`gudang_asal`,`gudang_tujuan`,`status_penggunaan`,`total`,`ket_penggunaan`,`id_periode`,`created_at`,`updated_at`,`deleted_at`) values 
(2,'BPKAD/PGN/1',1,'2021-01-01',NULL,NULL,'draft',NULL,NULL,NULL,'2021-10-01 03:06:34','2021-10-01 03:06:34',NULL),
(3,'BPKAD/PGN/2',1,'2021-02-01','BPKAD','Persediaan','final',170000,NULL,NULL,'2021-10-01 03:20:32','2021-10-20 02:34:25',NULL),
(4,'BPKAD/PGN/3',2,'2021-03-01','BPKAD','Persediaan','approved',34000,NULL,NULL,'2021-10-01 04:05:26','2021-10-20 02:34:05',NULL),
(5,'BPKAD/PGN/4',1,'2021-05-01','BPKAD','Persediaan','disetujui_ppbp',170000,NULL,NULL,'2021-10-01 15:32:35','2021-10-20 02:40:24',NULL),
(6,'BPKAD/PGN/5',1,'2021-05-01','BPKAD','Persediaan','disetujui_atasanLangsung',170000,NULL,NULL,'2021-10-01 16:22:07','2021-10-20 02:41:20',NULL),
(7,'BPKAD/PGN/6',1,'2021-05-01','BPKAD','Persediaan','final',170000,NULL,NULL,'2021-10-01 16:22:54','2021-10-20 02:46:00',NULL),
(8,'BPKAD/PGN/7',2,'2021-05-01','BPKAD','Persediaan','final',34000,'BPKAD/PGN/7',NULL,'2021-10-01 16:54:41','2021-10-23 15:29:29',NULL),
(11,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 16:57:31','2021-10-01 16:57:31',NULL),
(13,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 16:58:34','2021-10-01 16:58:34',NULL),
(14,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 16:59:46','2021-10-01 16:59:46',NULL),
(15,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:30:00','2021-10-01 17:30:00',NULL),
(16,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:31:19','2021-10-01 17:31:19',NULL),
(17,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:32:14','2021-10-01 17:32:14',NULL),
(18,NULL,1,'2000-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:32:55','2021-10-01 17:32:55',NULL),
(19,NULL,2,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:40:46','2021-10-01 17:40:46',NULL),
(20,NULL,1,'2021-04-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-01 17:44:30','2021-10-01 17:44:30',NULL),
(21,NULL,2,'2021-10-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 05:58:16','2021-10-02 05:58:16',NULL),
(22,NULL,1,'2021-11-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 05:59:14','2021-10-02 05:59:14',NULL),
(23,NULL,1,'2021-12-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 05:59:51','2021-10-02 05:59:51',NULL),
(24,NULL,2,'2021-12-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:00:12','2021-10-02 06:00:12',NULL),
(25,NULL,1,'2021-01-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:01:22','2021-10-02 06:01:22',NULL),
(26,NULL,2,'2021-01-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:01:30','2021-10-02 06:01:30',NULL),
(27,NULL,2,'2021-02-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:01:45','2021-10-02 06:01:45',NULL),
(28,NULL,2,'2021-03-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:02:31','2021-10-02 06:02:31',NULL),
(29,NULL,1,'2021-04-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-02 06:03:18','2021-10-02 06:03:18',NULL),
(30,NULL,1,'2021-06-01','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-03 06:03:12','2021-10-03 06:03:12',NULL),
(31,NULL,2,'2021-07-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-03 06:03:54','2021-10-03 06:03:54',NULL),
(32,NULL,2,'2021-07-02','BPKAD','Persediaan','draft',NULL,NULL,NULL,'2021-10-03 06:04:32','2021-10-03 06:04:32',NULL);
...
(2,'KP123BPKAD',NULL,'final',NULL,626000,NULL,'2021-08-05 04:28:08','2021-10-24 06:31:25',NULL),
...
(19,'dsjij','2021-01-01','final','sadjd',68000,NULL,'2021-08-18 01:02:44','2021-10-24 06:50:34',NULL),
(20,'123','2021-02-02','final','afs',34000,NULL,'2021-08-18 01:12:00','2021-10-24 06:34:20',NULL),
(21,'321',NULL,'final',NULL,68000,NULL,'2021-08-18 01:25:31','2021-10-24 06:32:58',NULL),
...
CREATE TABLE `tb_user` (
  ...
  CONSTRAINT `tb_user_ibfk_4` FOREIGN KEY (`id_jabatan`) REFERENCES `tb_jabatan` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_user` */

insert  into `tb_user`(`id`,`username`,`password`,`nama_user`,`dob`,`id_jabatan`,`id_opd`,`id_unit`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'super_admin','$2y$10$6.4OsPZXkTRcucF8q6CbJexVF7xgKQJVr8bS9Kh7v6kCmRfdMTPJ6','Super Admin','2021-01-01',1,1,1,NULL,NULL,NULL),
(13,'admin_bpkad','$2y$10$09vwfFubuwO3OdVfGWzv9.HQpKZni8rGYFohmknf//PdP9xKM5ml2','Admin BPKAD','2021-01-01',2,1,1,NULL,NULL,NULL),
(14,'ppbpb','$2y$10$M375M3.YxYwyccpulCuZsOazdhO68LJInubP2qxWKt.CLdrpWgNHW','PPBPB','2021-01-01',3,1,1,NULL,NULL,NULL),
(15,'kasi','$2y$10$.yqtNbo2di7F9yRFze8K3.jg6WVKlanRA7AiRwLzQQ2IS85LwW2Wq','KASI','2021-01-01',4,1,1,NULL,NULL,NULL),
(16,'ppbp','$2y$10$88mKMpM8N/pEbHMEskSpbObuXnG0UDpL2vQOOaLncWQOXK2pTBJ6q','PPBP','2021-01-01',5,1,1,NULL,NULL,NULL),
(17,'tim_verifikasi','$2y$10$d65Gx88kFhVtqmrmGmEFReqkHEpHVw7nxtO.NoC1VRzllmB/bX7bq','Tim Verifikasi','2021-01-01',6,1,1,NULL,NULL,NULL),
(18,'kadis','$2y$10$vX3.8e3PDoINmSr41z1MY.243TDFNeLcubEdmHd4./N4bkQhEJTba','KADIS','2021-01-01',7,1,1,NULL,NULL,NULL),
(19,'kasubag','$2y$10$MyTSbLEQhxynPjHE.eiKcOC7eT3wj3tRmdL/ijZbo8pcltWKW5jwW','KASUBAG','2021-01-01',8,1,1,NULL,NULL,NULL),
(20,'sekdis','$2y$10$87PmN9BAireT/Ta01uOYj.26S1KEzO6RBDzJnIdXjdAappJ6ID7TK','SEKDIS','2021-01-01',9,1,1,NULL,NULL,NULL);
